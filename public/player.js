  ...
  class Player {
      ...
      switch (event.code) {
        ...
        case 'KeyJ':
          ...
          if (
            ...
            console.log('[Debug] Attack initiated. isAttacking_:', this.isAttacking_, 'attackTimer_:', this.attackTimer_);
   ...
   SetAnimation_(name) {
    ...
    Update(timeElapsed, rotationAngle = 0) {
      ...
      console.log('[Debug] Update loop. isAttacking_:', this.isAttacking_, 'attackTimer_:', this.attackTimer_);
      ...
      if (this.isAttacking_) {
        ...
        if (this.attackTimer_ <= 0) {
            console.log('[Debug] Attack ended. isAttacking_:', this.isAttacking_);
            this.isAttacking_ = false;
        }
      }
